...
class AnalysisVersion():
    def __init__(self, version, version_id):
...
if __name__ == '__main__':
    ...
    analysisversion = AnalysisVersion(49, 28)
    ...
    with open("{}/materialization_log_v{}.pkl".format(HOME, analysisversion.version), "rb") as f:
        mod.args = pkl.load(f)
        # sql_uri = pkl.load(f)

    mod.args["n_threads"] = 1

    timings = {}

    time_start = time.time()
    df = materialize.materialize_all_annotations(mod.args["cg_table_id"],
